 ...
 */
export function inputCodeNumber5Validator(title?: string): ValidatorFn {
...
@Component({
  selector: 'input-code-number-5',
  templateUrl: './input-code-number-5.component.html',
  styleUrls: ['./input-code-number-5.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputCodeNumber5Component),
      multi: true,
    },
  ],
  standalone: true,
...
export class InputCodeNumber5Component
