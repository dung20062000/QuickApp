 ...
 * Validates that the description has length max 500
 * @param title
 * @returns {ValidatorFn} The validator function
 */
export function inputDesc500Validator(title?: string): ValidatorFn {
...
@Component({
  selector: 'input-desc-500',
  templateUrl: './input-desc-500.component.html',
  styleUrls: ['./input-desc-500.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputDesc500Component),
      multi: true,
    },
  ],
  standalone: true,
...
export class InputDesc500Component
