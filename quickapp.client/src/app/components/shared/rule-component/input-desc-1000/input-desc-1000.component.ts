 ...
 * Validates that the description has length max 1000
 * @param title
 * @returns {ValidatorFn} The validator function
 */
export function inputDesc1000Validator(title?: string): ValidatorFn {
...
@Component({
  selector: 'input-desc-1000',
  templateUrl: './input-desc-1000.component.html',
  styleUrls: ['./input-desc-1000.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputDesc1000Component),
      multi: true,
    },
  ],
  standalone: true,
...
export class InputDesc1000Component
