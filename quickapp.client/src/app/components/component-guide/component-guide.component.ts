    ...
    <div class="component-guide-layout">
      <nav class="sidebar">
        ...
        <ul class="nav-list">
          ...
          <li><a routerLink="date-pickers" routerLinkActive="active">Date Pickers</a></li>
          <li><a routerLink="selectors" routerLinkActive="active">Selectors</a></li>
          <li><a routerLink="gender-radio" routerLinkActive="active">Gender Radio</a></li>
        </ul>
      </nav>
      <main class="content">
