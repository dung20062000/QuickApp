        ...
        this.componentTests = [
            this.createComponentTest(
                ...
                },
                {
                    ...
                    events: {
                        ...
                        keyup: (event: any, componentTest: ComponentTest) => this.onKeyup(event, componentTest),
            ...
            this.createComponentTest(
                ...
                `Placeholder: 
                    ...
                    - Number hoặc null`,
                {
                    numberValue: [null, [Validators.required, inputNumberValidator("Số", 9999999999999, undefined)]],
                },
                {
                    label: "Số",
                    required: true,
...
- Text đã trim space đầu cuối`,
                {
                    name: ["", [Validators.required, inputTaxCode14Validator("Mã số thuế")]],
                },
                {
                    label: "Mã số thuế",
                    required: true,
...
- Text đã trim space đầu cuối`,
                {
                    phoneNumber: ["", [Validators.required, inputPhone12Validator("Số điện thoại")]],
                },
                {
                    label: "Số điện thoại",
                    required: true,
...
- Text đã trim space đầu cuối`,
                {
                    phoneNumber: ["", [Validators.required, inputCCCD12Validator("Số CCCD")]],
                },
                {
                    label: "Số CCCD",
                    required: true,
...
- Text đã trim space đầu cuối`,
            ...
            this.createComponentTest(
                ...
                - Text đã trim space đầu cuối`,
                {
                    password: ["", [Validators.required, inputPasswordValidator("Mật khẩu")]],
                },
                {
                    label: "Mật khẩu",
                    required: true,
